...
<head>
    ...
    <title>SkillShop - Buy and Sell Skill</title>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-8 py-3 flex justify-between items-center gap-6">
        ...
        <div class="hidden md:flex flex-1 max-w-lg">
            <div class="relative w-full">
                <input type="text" placeholder="Search, skills, instructors,..." class="w-full px-4 py-2.5 bg-gray-50 border
                ...
                <button class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-blue-600 transition-colors">🔍</button>
            </div>
        </div>
        ...
        <div class="flex gap-1 sm:gap-2 items-center">
            <?php if($loggedIn):?>
                ...
                <a href="<?php echo $userRole == "Buyer" ?
                     "buyer-dashboard.php?tab=messages" : "seller-dashboard.php?tab=messages"; ?>"
                    ...
                    ✉️<span class="absolute top-1 right-1 w-2 h-2 bg-blue-500 rounded-full animate-pulse"></span>
                </a>
                ...
                <div class="relative ml-2 sm:ml-4 pl-2 sm:pl-4 border-l border-gray-200">
                    <button class="flex items-center gap-3 hover:bg-gray-50 px-2 py-1
                        rounded-lg transition-colors duration-200" id="profileBtn">
                        <img src="assets/images/avatar.jpg" class="w-8 h-8 rounded-full ring-2 ring-transparent
            ...
            <?php else: ?>
                    <a href="index.php" class="text-blue-600 px-4 py-2 rounded-lg
                        hover:bg-blue-50 font-medium text-sm transition-colors">Sign In
                    </a>

                    <a href="index.php" class="bg-gradient-to-r from-blue-600 to-indigo-600
                        text-white px-4 py-2 rounded-lg hover:shadow-lg hover:from-blue-700
                        hover:to-indigo-700 font-medium transition-all text-sm">Join
                    </a>
