function createAccount() {
    ...
    if (!fname || !lname || !email || !password || !cpassword) {
        ...
        form.append('terms_conditions', termsConditions.checked);
            ...
            if (r.readyState == 4) {
                ...
                if (r.status == 200) {
                    if (r.responseText == 'success') {
                        ...
                        signinErrorMessage.innerHTML = 'Login Successfull!';
                        setTimeout(() => {
...
function forgotPassword() {
    ...
    if (!email || !validateEmail(email)) {
        ...
        r.onload = () => {
            ...
            msg.innerHTML = response == 'success' ? 'Verification code sent to your email!' : response;
